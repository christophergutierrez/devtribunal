...
3. **Review files**: For each file, review it:
...
6. **Check documentation**: If any README or documentation files are in the changed list, call `check_docs` on them.
...
9. **Present results**: Show the final action plan, noting this review covers all uncommitted work-in-progress and their blast radius.
